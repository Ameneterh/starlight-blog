...
export default function CallToAction() {
  ...
  return (
    <div className="flex flex-col sm:flex-row p-3 border-2 md:border-4 border-teal-500 justify-center items-center rounded-tl-3xl rounded-br-3xl text-center">
